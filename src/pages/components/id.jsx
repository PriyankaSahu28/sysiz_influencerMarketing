          ...
          <form>
            <div id={styles.formcontainer}>
              ...
              <button id={styles.facebook} onClick={handleFacebookSignin}>
                <img id={styles.facebook1} src="images/facebook.png" />
                <span id={styles.btntext}> Facebook</span>
              </button>
              <button id={styles.google} onClick={handleGoogleSignin}>
                <img id={styles.google1} src="images/google.png" />
                <span id={styles.btntext}> Google</span>
              </button>
              <p id={styles.text3}>Not a Member?</p>
              <a id={styles.signup} href="#">
                Signup Now
              </a>
            </div>
          </form>
