          ...
          <div className="container-fluid">
            <div className="row">
              <div className="col-md-6 col-lg-4">
                <div className="card mb-3 mr-0  ml-0 widget-content bg-midnight-bloom">
              ...
              <div className="col-md-6 col-lg-4">
                <div className="card mb-2 mr-0 ml-0 widget-content bg-arielle-smile">
                  <div className="widget-content-wrapper text-white">
                    <div className="widget-content-left">
              ...
              <div className="col-md-6 col-lg-3">
                <div className="card mb-2 mr-100 ml-0 widget-content bg-grow-early">
                  <div className="widget-content-wrapper text-white">
                    <div className="widget-content-left">
              ...
              <div className="d-xl-none d-lg-block col-md-6 col-xl-4">
                <div className="card mb-2 widget-content bg-premium-dark">
                  <div className="widget-content-wrapper text-white">
                    <div className="widget-content-left">
